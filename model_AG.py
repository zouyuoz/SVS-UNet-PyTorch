...
class UNet(nn.Module):
    ...
    def forward(self, mix):
        ...
        conv4_att = self.att2(g=deconv2_out, x=conv4_out)
        ...
        conv3_att = self.att3(g=deconv3_out, x=conv3_out)
        ...
        conv2_att = self.att4(g=deconv4_out, x=conv2_out)
        ...
        conv1_att = self.att5(g=deconv5_out, x=conv1_out)
